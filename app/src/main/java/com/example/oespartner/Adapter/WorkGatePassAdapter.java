...
public class WorkGatePassAdapter extends RecyclerView.Adapter<WorkGatePassAdapter.MyviewHolder> {
    ...
    public void onBindViewHolder(WorkGatePassAdapter.MyviewHolder holder, int position) {
        ...
        holder.txtStackHolderId.setText(workGatePassModels.get(position).getStakeholder_id());
        holder.txtPersonId.setText(workGatePassModels.get(position).getPerson_id());
        holder.txtPersonName.setText(workGatePassModels.get(position).getPerson_name());
        holder.txtValidity.setText(workGatePassModels.get(position).getP_valid_upto());
...
//    }
    ...
    public void editWorkGatePass(String id) {
        String editVisitorGatePass_url = "http://oestech.com/management/vehicle_management/index.php/home_api/get_work_gatepass";
